...
function result = main_tracking(exposure, varargin)
  ...
  parameters.locationtracking = 0; %If set to 1 program calculates location based average jump distances instead of MSD and JD for entire cell, and then makes heatmap of this value
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  if  parameters.interactive == 0
    ...
    if parameters.minLength > 1 & results.ntracks > 0
